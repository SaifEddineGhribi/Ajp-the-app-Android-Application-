...
public class SortieActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    button_enregistrer.setOnClickListener(new View.OnClickListener() {@Override
  ...
  private void add_total() {
    ...
    else mGlobaldata.setValue(dd.toString());
  ...
  private void update_user() {
    ...
    if (checkBox_avec.isChecked()) user_database.child("Sorties").child("Sortie " + Integer.toString(nombresorties + 1)).child("Rendez-vous").setValue("oui");
    if (checkBox_sans.isChecked()) user_database.child("Sorties").child("Sortie " + Integer.toString(nombresorties + 1)).child("Rendez-vous").setValue("non");
