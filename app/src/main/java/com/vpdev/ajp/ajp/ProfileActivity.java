...
/**
 *
 * @author Saif eddine GHRIBI 03/07/2017
 */
...
public class ProfileActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    button_ajouter_une_sortie.setOnClickListener(new View.OnClickListener() {@Override
  ...
  static public void Store() {
    ...
    // Name ..........
    mRef_total.addValueEventListener(new ValueEventListener() {@Override
    ...
    mRef_name.addValueEventListener(new ValueEventListener() {@Override
      public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    mRef_email.addValueEventListener(new ValueEventListener() {@Override
      public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    mRef_depenses.addValueEventListener(new ValueEventListener() {@Override
      public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    mRef_nombre_de_sorties.addValueEventListener(new ValueEventListener() {@Override
      public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    mRef_phone.addValueEventListener(new ValueEventListener() {@Override
      public void onDataChange(DataSnapshot dataSnapshot) {
